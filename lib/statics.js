...
// config
//================================================================================
//TO DO : use environment variables instead
 ...
 * @returns {*} - The documents returned
 */
module.exports.getDocsFromOffset = function getDocsFromOffset(offset, targetIndex = configElasticsearch.index) {
  return Promise.try(() => {
    return esClient.search({
      index: targetIndex,
      type: "_doc",
 ...
 * @returns {*} - The documents returned
 */
module.exports.countAllDocs = function countAllDocs(targetIndex = configElasticsearch.index) {
  return Promise.try(() => {
